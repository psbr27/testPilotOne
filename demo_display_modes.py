...
def generate_test_results(count=20):
    ...
    for i in range(count):
        ...
        duration = random.uniform(
            0.1, 2.0
        )  # Random duration between 0.1-2.0 seconds
...
def demo_display_mode(display_type, description):
    ...
    print(
        "(Each test completes in 0.3-0.5 seconds to simulate real conditions)"
    )
...
def main():
    ...
    print(
        "  --display-mode progress_only   # Shows only counters during execution"
    )
