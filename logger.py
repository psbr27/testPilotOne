...
def get_logger(name: str = "TestPilot", log_to_file: bool = True, log_dir: str = "logs") -> logging.Logger:
    """
    ...
    if not logger.handlers:
        ...
        if log_to_file:
            try:
                ...
                error_log_file = os.path.join(log_dir, f"testpilot_failures_{timestamp}.log")
