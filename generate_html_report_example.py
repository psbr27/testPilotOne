...
def create_sample_test_results():
    ...
    for i in range(5):
        ...
        result = TestResult(
            ...
            error="" if passed else f"Error: Expected status 201 but got 400. Invalid data format.",
            expected_status=201,
...
def main():
    ...
    if len(sys.argv) > 1 and os.path.exists(sys.argv[1]):
        ...
        print("No JSON file provided or file not found. Creating sample test results...")
