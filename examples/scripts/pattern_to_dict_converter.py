...
class PatternToDictConverter:
    ...
    def convert_pattern(self, pattern: str) -> Dict[str, Any]:
        ...
        if not pattern or not isinstance(pattern, str):
            return self._create_result(
                "raw_value", pattern, "empty_or_invalid"
            )
        ...
        try:
            ...
            self.conversion_stats["conversion_types"][conversion_type] = (
                self.conversion_stats["conversion_types"].get(
                    conversion_type, 0
                )
                + 1
            )
            ...
            return self._create_result(
                "error", pattern, "conversion_failed", error=str(e)
            )
    ...
    def _looks_like_json(self, pattern: str) -> bool:
        ...
        return (
            ...
            or (pattern.count('"') >= 2 and ":" in pattern)
        )
    ...
    def _looks_like_header(self, pattern: str) -> bool:
        ...
        return any(
            pattern.lower().startswith(hp.lower()) for hp in header_patterns
        )
    ...
    def _convert_json_pattern(self, pattern: str) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                return self._create_result(
                    "json_object", parsed, "direct_json_parse"
                )
            ...
            return self._create_result(
                "json_extracted", kv_pairs, "json_key_value_extraction"
            )
    ...
    def _convert_quoted_kv_pattern(self, pattern: str) -> Dict[str, Any]:
        ...
        return self._create_result(
            "quoted_kv", kv_pairs, "quoted_key_value_parse"
        )
    ...
    def _convert_header_pattern(self, pattern: str) -> Dict[str, Any]:
        ...
        if pattern.lower().startswith("server:"):
            ...
            result = {"header_type": "server", "server_value": server_value}
            ...
            result = {"header_type": "user_agent", "user_agent": ua_value}
    ...
    def _create_result(
        self, pattern_type: str, data: Any, method: str, error: str = None
    ) -> Dict[str, Any]:
    ...
    def _generate_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "conversion_type_breakdown": self.conversion_stats[
                "conversion_types"
            ],
        }
...
def integrate_with_excel_parser(
